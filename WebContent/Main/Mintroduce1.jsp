...
<body>
    ...
    <section class="leftMenu">
       <div class="leftMenulist">
        <ul>
            <li><a href="./Mintroduce.bit">학원소개</a>
            <li><a href="./Mintroduce.bit">개요</a></li>
            <li><a href="./Main/Mintroduce2.jsp">인사말</a></li>
            <li><a href="./Main/Mintroduce3.jsp">회사연혁</a></li>
            <li><a href="./Main/Mintroduce4.jsp">시설 및 장비</a></li>
            <li><a href="./Main/Mintroduce5.jsp">찾아오시는 길</a></li>
        </ul>
        </div>
    </section>
    <div class="picture">
    <img src="./imgs/summary.jpg" style="height: 490px;padding-left: 300px;padding-top: 50px;">
    </div>
