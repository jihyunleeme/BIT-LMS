...
<%@ page import = "com.bit.model.dto.ReviewDto" %>
<!DOCTYPE html>
<html>
<head>
...
<% ReviewDto list = (ReviewDto)request.getAttribute("review"); %>
	...
	<!--목록 위에 칸 넓이-->
		...
		<thead>
		 ...
		 <!--thead th 속성 값 적용-->  	
           ...
           <div class="detailview" id="bord" style="text-align: center">
        	<%=list.getCont() %>
     </div>
     <div>
        <a href="./Mreview.bit"><button type="submit" style="float: right;">목록</button></a>
    </div>
    </div>
