    ...
    <section class="leftMenu">
       <div class="leftMenulist">
        <ul>
            ...
            <li><a href="./Mintroduce2.jsp">인사말</a></li>
            <li><a href="./Mintroduce3.jsp">회사연혁</a></li>
            <li><a href="./Mintroduce4.jsp">시설 및 장비</a></li>
            <li><a href="./Mintroduce5.jsp">찾아오시는 길</a></li>
        </ul>
        </div>
    </section>
    <div>
    <img src="../imgs/facility.JPG" style="height: 490px;padding-left: 300px;padding-top: 50px;">
    </div>
